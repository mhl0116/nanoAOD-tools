#ifndef PhysicsTools_NanoAODTools_EnergyScaleCorrection_h
#define PhysicsTools_NanoAODTools_EnergyScaleCorrection_h

//class taken directly from https://github.com/cms-sw/cmssw/blob/master/RecoEgamma/EgammaTools/interface/EnergyScaleCorrection.h
